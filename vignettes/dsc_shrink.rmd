---
title: "outputParser Illustration"
...
When we add a method using the wrapper we specify its outputtype:
```{r}
addMethod(dsc_shrink,"ashr",ash.wrapper,outputtype="ash_output")
addMethod(dsc_shrink,"ashr-max100",ash.wrapper,outputtype="ash_output",args=list(control=list(maxiter=100)))
```
