...
#'
#' @param ... Arguments passed to \code{\link{add_method}}.
#' 
#' @export
#' 
addMethod <- function(...) {
...
#'
#' @param ... Arguments passed to \code{\link{add_output_parser}}.
#' 
#' @export
#' 
addOutputParser <- function(...) {
    warning(paste("The function addOutputParser is deprecated. Use",
                  "add_output_parser instead."))
    return(add_output_parser(...))
}

#' Deprecated alias to \code{\link{add_scenario}}.
#'
#' @param ... Arguments passed to \code{\link{add_scenario}}.
#' 
#' @export
#' 
addScenario <- function(...) {
    warning(paste("The function addScenario is deprecated. Use",
                  "add_scenario instead."))
    return(add_scenario(...))
}

#' Deprecated alias to \code{\link{add_score}}.
#'
#' @param ... Arguments passed to \code{\link{add_score}}.
#' 
#' @export
#' 
addScore <- function(...) {
...
#'
#' @param ... Arguments passed to \code{\link{get_output_types}}.
#' 
#' @export
#' 
getOutputtypes <- function(...) {
    warning(paste("The function getOutputtypes is deprecated. Use",
                  "get_output_types instead."))
    return(get_output_types(...))
}

#' Deprecated alias to \code{\link{list_methods}}.
#'
#' @param ... Arguments passed to \code{\link{list_methods}}.
#' 
#' @export
#' 
listMethods <- function(...) {
    warning(paste("The function listMethods is deprecated. Use",
                  "list_methods instead."))
    return(list_methods(...))
}

#' Deprecated alias to \code{\link{list_scenarios}}.
#'
#' @param ... Arguments passed to \code{\link{list_scenarios}}.
#' 
#' @export
#' 
listScenarios <- function(...) {
    warning(paste("The function listScenarios is deprecated. Use",
                  "list_scenarios instead."))
    return(list_scenarios(...))
}

#' Deprecated alias to \code{\link{list_scores}}.
#'
#' @param ... Arguments passed to \code{\link{list_scores}}.
#' 
#' @export
#' 
listScores <- function(...) {
...
#'
#' @param ... Arguments passed to \code{\link{list_output_parsers}}.
#' 
#' @export
#' 
listoutputParsers <- function(...) {
    warning(paste("The function listoutputParsers is deprecated. Use",
                  "list_output_parsers instead."))
    return(list_output_parsers(...))
}

#' Deprecated alias to \code{\link{load_example}}.
#'
#' @param ... Arguments passed to \code{\link{load_example}}.
#' 
#' @export
#' 
...
#'
#' @param ... Arguments passed to \code{\link{new_dsc}}.
#' 
#' @export
#' 
new.dsc <- function(...) {
...
#'
#' @param ... Arguments passed to \code{\link{source_dir}}.
#' 
#' @export
#' 
sourceDir <- function(...) {
